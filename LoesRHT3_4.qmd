...
## Aufgabe 3
### a
X ist die Anzahl abgeschlossener Verträge,
m ist die Anzahl verkaufter Wärmepumpe.
Jeder Abschluss einer Service-Vertrags ist unabhängig. Daher kann formuliert werden:
x ~ B(m, pi = 0.5)

### b
Erfolgswahrscheinlichkeit der Filiale:
pi = X/m = 16/50 = 0.32

### c
H0-Hypothese: Die Verkaufswahrscheinlichkeit ist in der Filiale gelich gross wie
im Gesamtunternehmen.
```{r}
binom.test(15, 50, p = 0.5)
```
Der berechnete p-Wert ist kleiner als 0.05, H0 muss verworfen werden. 
Die Verkaufwahrscheinlichkeit in der Filiale ist also kleiner.
