...
#### Streudiagramm:
auf der X-Achse werden die Daten mit der grösseren Genauigkeit/Präzision gelegt
in R: plot(y ~ x)
...
#### Korrelationen
Schwerpunkt: 
Mittelwert x-Werte, Mittelwert y-Werte. Schnittpunkt der Achsen-Parallelen ist der Schwerpunkt
...
für bis zu 8 einigermassen noch übersichtlich


# Unterricht Andreas Ruckstuhl

```{r}
path.yeast <- "C:\\Users\\oliver.speer\\Documents\\ZHAW\\Hefezellen.dat"
