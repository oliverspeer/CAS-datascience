...
## Faustregel B1
Den Zufallsstreubereich kann man wieder approximativ mit der
2σ-Approximation (vgl. 2.4.g) bestimmen.
Zur Erinnerung: 95% Zufallsstreubereich ist approximativ
Erwartungswert ± 2xStandardabweichung
– Sei also pi 0 die Eintrittswahrscheinlichkeit aus der Null-Hypothese,
dann ist der 95%-Zufallsstreubereich (≡ Annahmebereich zum
Signifikanzniveau 5%) genähert
